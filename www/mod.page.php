<?php 
    // Si on ne désire pas utiliser le moteur de template
    ...
    // Vérif status user
    // $objAccount = new Classes\Tool\Account($objAuth->getValue('account_id'));
    // if($objAccount->getValue('status') == 0) $objAuth->stopAuthSession();
